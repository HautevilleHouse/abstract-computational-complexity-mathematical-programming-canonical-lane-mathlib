import HautevilleHouse.AbstractComputationalComplexityMathematicalProgrammingCanonicalLaneLean.FinalTheorem
...
Abstract Computational Complexity Mathematical Programming endgame pilot. The pilot closes over its admitted class and carries the
...
def commonCoreProjectionLawAvailable : Prop :=
  ∀ {X : Type} [Add X] [Sub X] (L : AdditiveLane X),
